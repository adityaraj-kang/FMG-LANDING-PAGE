            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-black border border-white/10 rounded-3xl p-10 relative overflow-hidden group" style={{ WebkitMaskImage: "-webkit-radial-gradient(white, black)" }}>
                        <span className="text-8xl font-black text-white/10 absolute -right-4 -bottom-8 font-display">01</span>
                    ...
                    {/* Step 2 */}
                    <div className="bg-black border border-white/10 rounded-3xl p-10 relative overflow-hidden group" style={{ WebkitMaskImage: "-webkit-radial-gradient(white, black)" }}>
                        <span className="text-8xl font-black text-white/10 absolute -right-4 -bottom-8 font-display">02</span>
                        <div className="w-14 h-14 bg-white/10 flex items-center justify-center rounded-2xl mb-8 text-white">
                    ...
                    {/* Step 3 */}
                    <div className="bg-black border border-white/10 rounded-3xl p-10 relative overflow-hidden group" style={{ WebkitMaskImage: "-webkit-radial-gradient(white, black)" }}>
                        <span className="text-8xl font-black text-white/10 absolute -right-4 -bottom-8 font-display">03</span>
